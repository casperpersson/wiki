...
var mouseLeftEdgeOpensMenu = true; // When mouse close to the left edge, reveals menu if unpinned
...
function moCallback(e, t) {
  ...
  (header = document.querySelector("header[data-booted='true']")),
    ...
    navigation &&
      !navProcessed &&
      (customizeNavigation(navigation), (navProcessed = !0)),
    main &&
      !mainProcessed &&
      (customizeMainContent(main), (mainProcessed = !0)),
    footer &&
      !footerProcessed &&
      (customizeFooter(footer), (footerProcessed = !0)),
...
function customizeNavigation(e) {
      ...
      ? t.forEach(function (e) {
          e.childNodes[0] && fixMobileDeviceNodeValue(e.childNodes[0]),
            e.childNodes[1] &&
              ...
              fixMobileDeviceNodeValue(e.childNodes[1].childNodes[0]);
        })
      : (t.forEach(function (e) {
          ...
          if ("DVD" == (menuItemType = getMenuItemType(e)) && hideDivider)
            ...
            n.wrapGroup(CM_SECTION),
              ...
              sectionContainsActivePage(n)
                ...
                : t.href == curPathAbs &&
                  (t.classList.add(CM_LNK_ACTIVE2),
                  t.nextElementSibling.classList.add(CM_SECTION_EXPANDED),
                  t.classList.toggle(CM_COLLAPSIBLE_ACTIVE),
                  t.classList.toggle(CM_COLLAPSIBLE_INACTIVE)),
  ...
  !mobileDevice &&
    slidingMenu &&
    (((pmbHolder = document.createElement("button")).className =
      "v-btn v-btn--top v-btn--depressed v-btn--fab v-btn--fixed v-btn--left v-btn--round theme--dark v-size--small primary mad-pmb"),
    (pmbHolder.type = "button"),
    pmbHolder.insertAdjacentHTML(
      "afterbegin",
      '<span class="v-btn__content"><i aria-hidden="true" class="v-icon notranslate mdi theme--dark ' +
        icon_pinOff +
        '" style="transform:rotate(0deg);"></i></span>'
    ),
    (pmb = pmbHolder.querySelector("i")),
    ((mbHolder = document.createElement("button")).className =
      "v-btn v-btn--top v-btn--depressed v-btn--fab v-btn--fixed v-btn--left v-btn--round theme--dark v-size--small primary mb"),
    (mbHolder.type = "button"),
    mbHolder.insertAdjacentHTML(
      "afterbegin",
      '<span class="v-btn__content"><i aria-hidden="true" class="v-icon notranslate mdi theme--dark ' +
        icon_menu +
        '"></i></span>'
    ...
    pinMenu
      ? (pmb.classList.add(icon_pinOff),
        menuOpen(),
        e.classList.add("mad-nav-visible"))
...
function customizeMainContent(e) {
  if (
    ...
    removeBreadcrumbs &&
      !breadcrumbsHidden &&
      breadcrumbs &&
      (breadcrumbs.nextSibling && breadcrumbs.nextSibling.remove(),
      breadcrumbs.remove(),
      (breadcrumbsHidden = !0)),
    ...
    if (
      (hideSideColumn =
        ...
        removeHistoryCard &&
        removeBookmarkCard) ||
      !1 === sideColumnPosition ||
      "false" === sideColumnPosition
    ) {
      sideColumn.remove(),
        (sideColumnHidden = !0),
        (n = e.querySelector("div.offset-lg-3.offset-xl-2")) &&
          n.classList.remove("offset-lg-3", "offset-xl-2");
  ...
  mobileDevice ||
    ...
    pinMenu
      ...
      : (breadcrumbs &&
          breadcrumbs
            .querySelector("div")
            .style.setProperty("padding-left", "56px", "important"),
        pageTitle &&
          breadcrumbsHidden &&
          pageTitle.style.setProperty("padding-left", "56px", "important"),
  ...
  Array.from(o).forEach((e) => {
    removeTocCard &&
      e.querySelector("div[role=list]") &&
      (e.remove(), (removeTocCard = !1)),
      removeTagCard &&
        e.innerHTML.includes("mdi-tag") &&
        (e.remove(), (removeTagCard = !1)),
      removeBookmarkCard &&
        e.innerHTML.includes("mdi-bookmark") &&
        (e.remove(), (removeBookmarkCard = !1)),
      removeHistoryCard &&
        (e.innerHTML.includes("mdi-history") ||
          (e.innerHTML.includes("caption") &&
            !e.innerHTML.includes('role="listitem"') &&
            !e.innerHTML.includes("mdi-tag"))) &&
        (e.remove(), (removeHistoryCard = !1));
  });
...
function headerAppendIcon(e, t) {
  ...
  (n.className = "v-avatar v-list-item__avatar rounded-0 v-avatar--tile"),
    (n.style = "height: 24px; min-width: 24px; width: 24px;");
  var o = document.createElement("i");
  (o.className = "v-icon notranslate " + t + " theme--dark"),
...
const fnmap = { toggle: "toggle", show: "add", hide: "remove" },
  sectionState = (e, t) => {
    if (!sectionContainsActivePage(e)) {
      ...
      e.parentNode
        .querySelectorAll("." + CM_SECTION + "." + CM_SECTION_EXPANDED)
        .forEach(function (n) {
          var o = n.previousElementSibling;
          n == e ||
            sectionContainsActivePage(n) ||
            o.href == curPathAbs ||
            (n.classList[fnmap[t]](CM_SECTION_EXPANDED),
            n.previousElementSibling.classList[fnmap[t]](CM_COLLAPSIBLE_ACTIVE),
            n.previousElementSibling.classList[fnmap[t]](
              CM_COLLAPSIBLE_INACTIVE
            ));
        }),
...
function groupItems(e) {
  ...
  do {
    ...
    e &&
    getMenuItemInfo(e, "level") ==
      getMenuItemInfo(e.previousElementSibling, "level")
  );
  return t;
}
function getMenuItemInfo(e, t) {
  ...
  o &&
    ((e = e.replace(o[0], "")),
    0 == (o = o[0].split("#")[1]).toLowerCase().indexOf("mdi-") &&
      (o = "mdi " + o));
  var i = e.split("#");
  if (i.length > 1) {
    if (isNumeric(i[1])) {
...
function removePrismJSLineNumbers(e) {
  [].forEach.call(e.getElementsByClassName("prismjs"), function (e) {
    e.classList.remove("line-numbers"),
      e.childNodes[0].setAttribute("style", "margin-left: -2rem;"),
      e.querySelector("span[class='line-numbers-rows']").remove();
  });
}
...
function navEvent() {
  "mouseenter" === event.type
    ...
    ? (isMouseOverNav = !1)
    : "mouseover" === event.type && (isMouseOverNav = !0),
    mbHolder.contains(event.relatedTarget) ||
      pmbHolder.contains(event.relatedTarget) ||
      ("mouseenter" === event.type && pmbShow(),
      "mouseleave" === event.type && (pinMenu ? pmbHide() : menuClose()));
}
function pmbEvent() {
  "mouseup" === event.type
    ? toggleMenuPin()
...
function toggleMenuPin() {
  document.activeElement && document.activeElement.blur(),
    ...
    pinMenu
      ? (menuOpen(),
        breadcrumbs &&
          breadcrumbs.querySelector("div").style.removeProperty("padding-left"),
        pageTitle &&
          breadcrumbsHidden &&
          pageTitle.style.removeProperty("padding-left"),
        ...
        btnToTop &&
          "235px" != btnToTop.style.left &&
          (btnToTop.style.left = "235px"),
    ...
    ? (pmbHolder.classList.add(
      ...
      setTimeout(function () {
        pmbHolder.classList.remove("fab-transition-enter"),
          ...
          pmbHolder.classList.remove(
            "fab-transition-enter-active",
            "fab-transition-enter-to"
          );
      }, 300))
    : "hide" == e.toLowerCase() &&
      (pmbHolder.classList.add(
...
function handleMouseMove(e) {
  ...
  null == (e = e || window.event).pageX &&
    null != e.clientX &&
    ((n = (t = (e.target && e.target.ownerDocument) || document)
      .documentElement),
    (o = t.body),
    (e.pageX =
      e.clientX +
  ...
  faccordion = function () {
    function e(e, t, n, o) {
      ...
      window.requestAnimationFrame(function r(b) {
        ...
        var g = b - i;
        o
          ? ((e.style.height = m * g + "px"),
            (e.style.paddingTop = u * g + "px"),
            (e.style.paddingBottom = p * g + "px"),
            (e.style.marginTop = f * g + "px"),
            (e.style.marginBottom = v * g + "px"))
          : ((e.style.height = a - m * g + "px"),
            (e.style.paddingTop = s - u * g + "px"),
            (e.style.paddingBottom = l - p * g + "px"),
            (e.style.marginTop = d - f * g + "px"),
            (e.style.marginBottom = c - v * g + "px")),
          g >= t
            ? ((e.style.height = ""),
              (e.style.paddingTop = ""),
    ...
    var t = function (e, t) {
        ...
        for (let r = 0; r < o.length; r++)
          i || e !== o[r] ? i && o[r].matches(t) && n.push(o[r]) : (i = !0);
        return n;
      },
      n = function (t) {
        var n, o, i;
        t &&
          ...
          (o = 350),
          0 === (n = t).clientHeight ? e(n, o, i, !0) : e(n, o, i));
      },
      o = function (t) {
        var n;
    ...
    document.querySelectorAll("div.faccordion").forEach((e) => {
      e.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach((e) => {
        ...
        e.querySelector("ul") &&
          e.querySelector("ul").classList.add("faccordion"),
        ...
        e.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach((e) => {
          Array.prototype.slice.call(e.parentNode.children).forEach((t) => {
            t.parentNode.querySelectorAll("div .inner").length
        ...
        e.onclick = function (r) {
          if (
            ...
            r[0] && r[0].classList.contains("show")
              ? (o(r[0]),
                e.parentNode
                  .querySelectorAll(".toggle.show.expanded")
                  .forEach((e) => {
                    let o = t(e, ":not(div)");
              ...
              : ((function (e, t) {
                  Element.prototype.matches ||
                    (Element.prototype.matches =
                      ...
                      Element.prototype.webkitMatchesSelector);
                  var n = [];
                  for (let o of e.parentNode.children)
                    o !== e && o.matches(t) && n.push(o);
                  return n;
